...
public class MetadataServletCoverageTest extends OBBaseTest {
    ...
    public void testDoPost_NotFoundException() throws Exception {
        ...
        when(mockRequest.getParameter("isc_dataFormat")).thenReturn("json");
        when(mockRequest.getMethod()).thenReturn("POST");
        when(mockRequest.getRequestURI()).thenReturn("/sws/com.etendoerp.metadata.meta/unknown");

        servlet.doPost("", mockRequest, mockResponse);

        verify(mockResponse).setStatus(eq(Utils.getHttpStatusFor(new NotFoundException())));
        verify(mockResponse).setContentType(contains("application/json"));
    }
    ...
    public void testHandleException_AcceptHeaderJson() throws Exception {
        when(mockRequest.getPathInfo()).thenReturn("/unknown");
        when(mockRequest.getParameter("isc_dataFormat")).thenReturn(null);
    ...
    public void testHandleException_HtmlResponse_NoJsonIndicators() throws Exception {
        ...
        verify(mockResponse).setContentType(contains("text/html"));
