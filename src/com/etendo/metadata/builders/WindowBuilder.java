...
public class WindowBuilder {
    ...
    public JSONArray getTabsAndFields(List<TabAccess> tabAccesses, org.openbravo.model.ad.ui.Window window) throws JSONException {
        ...
        if (tabAccesses.isEmpty()) {
            ...
            // certain tabs
            for (TabAccess tabAccess : tabAccesses.stream().filter(tabAccess -> tabAccess.isActive() && tabAccess.isAllowRead() && tabAccess.getTab().isActive() && tabAccess.getTab().isAllowRead()).collect(Collectors.toList())) {
    ...
    private void setSelectorProperties(List<SelectorField> fields, SelectorField displayField, SelectorField valueField, JSONObject selectorInfo) throws JSONException {
        ...
        for (SelectorField field : fields) {
            ...
            // get extra properties
            if (!(field.isOutfield() && (displayField != null && !fieldName.equals(displayFieldProperty)) || (valueField != null && !fieldName.equals(valueFieldProperty))) && field.isOutfield()) {
