...
public class Utils {
  private static final Class<SecureWebServicesUtils> UTILS = SecureWebServicesUtils.class;
  ...
  private static Role getRole(Role role, List<UserRoles> userRoleList, Role defaultWsRole, Role defaultRole) {
    try {
      Method method = UTILS.getDeclaredMethod("getRole", Role.class, List.of(UserRoles.class).getClass(), Role.class,
          Role.class);
  ...
  private static Organization getOrganization(Organization org, Role selectedRole, Role defaultRole,
    ...
    try {
      Method method = UTILS.getDeclaredMethod("getOrganization", Organization.class, Role.class, Role.class,
          Organization.class);
  ...
  private static Warehouse getWarehouse(Warehouse warehouse, Organization selectedOrg, Warehouse defaultWarehouse) {
    try {
      Method method = UTILS.getDeclaredMethod("getWarehouse", Warehouse.class, Organization.class, Warehouse.class);
  ...
  private static String cleanPrivateKey(SWSConfig config) {
    try {
      Method method = UTILS.getDeclaredMethod("cleanPrivateKey", SWSConfig.class);
  ...
  private static Algorithm getEncoderAlgorithm(String privateKeyContent, String algorithmUsed) {
    try {
      Method method = UTILS.getDeclaredMethod("getEncoderAlgorithm", String.class, String.class);
