...
public class ServiceFactory {
    ...
    public ServiceFactory(final HttpSecureAppServlet servlet) {
        serviceEntries = List.of(new Service(path -> path.startsWith(Constants.WINDOW_PATH),
                                             WindowService::new),
                                 new Service(path -> path.startsWith(Constants.TAB_PATH),
                                             TabService::new),
                                 new Service(path -> path.startsWith(Constants.TOOLBAR_PATH),
                                             ToolbarService::new),
                                 new Service(path -> path.startsWith(Constants.LANGUAGE_PATH),
                                             LanguageService::new),
                                 new Service(path -> path.equals(Constants.MENU_PATH),
                                             MenuService::new),
                                 new Service(path -> path.equals(Constants.SESSION_PATH),
                                             SessionService::new),
                                 new Service(path -> path.equals(Constants.MESSAGE_PATH),
                                             MessageService::new),
    ...
    private static class Service {
        ...
        public Service(final Predicate<String> matcher, final BiFunction<HttpServletRequest, HttpServletResponse, MetadataService> creator) {
