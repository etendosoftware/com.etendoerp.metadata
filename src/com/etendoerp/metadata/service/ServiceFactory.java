...
public class ServiceFactory {
    ...
    public BaseService getService(final String path, final HttpServletRequest req, final HttpServletResponse res) {
    ...
    private static class Service {
        ...
        private final BiFunction<HttpServletRequest, HttpServletResponse, BaseService> creator;

        public Service(final Predicate<String> matcher,
                       final BiFunction<HttpServletRequest, HttpServletResponse, BaseService> creator) {
        ...
        public BaseService create(final HttpServletRequest req, final HttpServletResponse res) {
